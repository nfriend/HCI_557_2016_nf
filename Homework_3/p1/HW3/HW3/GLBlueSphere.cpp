...
GLBlueSphere::GLBlueSphere(float center_x, float center_y, float center_z, float radius, int rows, int segments)
{
...
*/
void GLBlueSphere::initShader(void)
{
	...
	_light_source1._lightPos = glm::vec4(60.0, 10.0, 50.0, 1.0);
	_light_source1._ambient_intensity = 0.0;
	_light_source1._specular_intensity = 0;
